...
The file "media.py" creates the class Movie. The file "entertainment_center.py" runs the instance of movie, and the file "fresh_tomatoes.py" contains the source code for running the page.